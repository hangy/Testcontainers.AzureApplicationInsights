...
public class IntegrationTest
{
    ...
    {
        AppInsightsBuilder builder = new AppInsightsBuilder()
            .WithImage("hangy-testcontainers-azureapplicationinsights-server:latest");
        ...
        await foreach(TrackedRequest? request in requests)
        {
            ...
            Assert.Contains("Hello World!", request.Body, StringComparison.InvariantCulture);
            atLeastOne = true;
        }
